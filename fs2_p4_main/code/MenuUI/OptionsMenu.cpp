...
const int REPEAT			  = (1<<0);
const int NO_MOUSE_OVER_SOUND =	(1<<1);
...
void options_cancel_exit()
{
	...
	g_MouseController.SetMouseState(Backup_use_mouse_to_fly ? MouseController::MOUSE_STATE_USE_TO_FLY : 0);
...
void options_button_pressed(int n)
{
	...
	switch (n) {		
		...
		case MOUSE_ON:
			g_MouseController.SetMouseState(MouseController::MOUSE_STATE_USE_TO_FLY);
			gamesnd_play_iface(SND_USER_SELECT);
			break;

		case MOUSE_OFF:
			g_MouseController.UnsetMouseState(MouseController::MOUSE_STATE_USE_TO_FLY);
			gamesnd_play_iface(SND_USER_SELECT);
			break;
	}
}
...
void options_sliders_update()
{
	...
	if (g_MouseController.GetMouseSensitivity() != Options_sliders[gr_screen.res][OPT_MOUSE_SENS_SLIDER].slider.pos) {
		g_MouseController.SetMouseSensitivity(Options_sliders[gr_screen.res][OPT_MOUSE_SENS_SLIDER].slider.pos);
		gamesnd_play_iface(SND_USER_SELECT);
	}
...
void options_menu_init()
{
	...
	*/
	...
	Backup_use_mouse_to_fly = g_MouseController.GetMouseState(MouseController::MOUSE_STATE_USE_TO_FLY);
	...
	Options_sliders[gr_screen.res][OPT_MOUSE_SENS_SLIDER].slider.pos = g_MouseController.GetMouseSensitivity();
