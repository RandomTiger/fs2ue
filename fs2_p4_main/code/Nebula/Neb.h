...
enum
{
	NEB2_RENDER_NONE,											// no rendering
	NEB2_RENDER_POLY,											// background is the old-school polygons
	NEB2_RENDER_POF,											// background is the nice pof file
	NEB2_RENDER_LAME,											// super simple nebula effect 
	NEB2_RENDER_SIMPLE								
};
