...
//	os_resume();
	...
	gr_screen.gf_set_bitmap_ptr = gr_glide_set_bitmap;
	...
	gr_screen.gf_set_palette_ptr = gr_glide_set_palette;
	gr_screen.gf_get_color = gr_glide_get_color;
	gr_screen.gf_init_color = gr_glide_init_color;
	gr_screen.gf_init_alphacolor_ptr = gr_glide_init_alphacolor;
	...
	// fog stuff
	gr_screen.gf_fog_set_ptr = gr_glide_fog_set;	
	...
	// texture cache set
	gr_screen.gf_tcache_set_ptr = glide_tcache_set;
