...
#endif
#else
inline void SPDBG_ASSERT(const bool condition) {assert(condition);}
inline void SPDBG_REPORT_ON_FAIL(const HRESULT hr) {}
inline void SPDBG_FUNC(const char * const msg) {}
#endif
