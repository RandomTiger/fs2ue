...
void red_alert_store_weapons(RedAlert::red_alert_ship_status *ras, ship_weapon *swp)
{
	using namespace RedAlert;
...
void red_alert_bash_weapons(RedAlert::red_alert_ship_status *ras, ship_weapon *swp)
{
	using namespace RedAlert;
...
void red_alert_bash_subsys_status(RedAlert::red_alert_ship_status *ras, ship *shipp)
{
	using namespace RedAlert;
...
void red_alert_store_subsys_status(RedAlert::red_alert_ship_status *ras, ship *shipp)
{
	using namespace RedAlert;
