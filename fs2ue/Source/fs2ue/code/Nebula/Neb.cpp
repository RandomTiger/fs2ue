...
void neb2_level_init()
{
	...
	Neb2_render_mode = NEB2_RENDER_SIMPLE;
...
{	
	...
	if(!(Neb2_render_mode == NEB2_RENDER_POF || Neb2_render_mode == NEB2_RENDER_SIMPLE) ){
		return;
	}
	...
	if(gr_screen.mode == GR_DIRECT3D5)
	{
	...
	if(Neb2_render_mode == NEB2_RENDER_SIMPLE)
	{
		ubyte r,g,b,a;
		bm_get_components(&tpixels[PIXEL_INDEX_SMALL(0, 0)], &r, &g, &b, &a);
		neb2_set_backg_color(r,g,b);
	}
...
{	
	...
	if(Neb2_render_mode == NEB2_RENDER_LAME || Neb2_render_mode == NEB2_RENDER_SIMPLE){
