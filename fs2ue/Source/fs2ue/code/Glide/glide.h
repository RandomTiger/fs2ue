...
FX_ENTRY void FX_CALL
guDrawTriangleWithClip( const GrVertex *a, const GrVertex *b, const GrVertex *c );
...
#ifndef _VOLITION_GLIDE_EXT
#define _VOLITION_GLIDE_EXT
...
extern void (__stdcall *grDrawLine)(const GrVertex *v1, const GrVertex *v2);
extern void (__stdcall *grDrawPlanarPolygon)(int nverts, const int ilist[], const GrVertex vlist[]);
extern void (__stdcall *grDrawPlanarPolygonVertexList)(int nverts, const GrVertex vlist[]);
extern void (__stdcall *grDrawPoint)(const GrVertex *pt);
extern void (__stdcall *grDrawPolygon)(int nverts, const int ilist[], const GrVertex vlist[]);
extern void (__stdcall *grDrawPolygonVertexList)(int nverts, const GrVertex vlist[]);
extern void (__stdcall *grDrawTriangle)(const GrVertex *a, const GrVertex *b, const GrVertex *c);
extern void (__stdcall *guDrawTriangleWithClip)(const GrVertex *a, const GrVertex *b, const GrVertex *c);
extern void (__stdcall *grBufferClear)(GrColor_t color, GrAlpha_t alpha, FxU16 depth);
extern int (__stdcall *grBufferNumPending)(void);
extern void (__stdcall *grBufferSwap)(int swap_interval);
extern void (__stdcall *grRenderBuffer)(GrBuffer_t buffer);

typedef void (*GrErrorCallbackFnc_t)(const char *string, FxBool fatal);

extern void (__stdcall *grErrorSetCallback)(GrErrorCallbackFnc_t fnc);
extern void (__stdcall *grSstIdle)(void);
extern FxU32 (__stdcall *grSstVideoLine)(void);
extern FxBool (__stdcall *grSstVRetraceOn)(void);
extern FxBool (__stdcall *grSstIsBusy)(void);
extern FxBool (__stdcall *grSstWinOpen)(
          FxU32                hWnd,
          GrScreenResolution_t screen_resolution,
          GrScreenRefresh_t    refresh_rate,
          GrColorFormat_t      color_format,
          ...
          int                  nColBuffers,
          int                  nAuxBuffers);
extern void (__stdcall *grSstWinClose)(void);
extern FxBool (__stdcall *grSstControl)(FxU32 code);
extern FxBool (__stdcall *grSstQueryHardware)(GrHwConfiguration *hwconfig);
extern FxBool (__stdcall *grSstQueryBoards)(GrHwConfiguration *hwconfig);
extern void (__stdcall *grSstOrigin)(GrOriginLocation_t origin);
extern void (__stdcall *grSstSelect)(int which_sst);
extern FxU32 (__stdcall *grSstScreenHeight)(void);
extern FxU32 (__stdcall *grSstScreenWidth)(void);
extern FxU32 (__stdcall *grSstStatus)(void);
extern void (__stdcall *grSstPerfStats)(GrSstPerfStats_t *pStats);
extern void (__stdcall *grSstResetPerfStats)(void);
extern void (__stdcall *grResetTriStats)();
extern void (__stdcall *grTriStats)(FxU32 *trisProcessed, FxU32 *trisDrawn);
extern void (__stdcall *grAlphaBlendFunction)(GrAlphaBlendFnc_t rgb_sf, GrAlphaBlendFnc_t rgb_df, GrAlphaBlendFnc_t alpha_sf, GrAlphaBlendFnc_t alpha_df);
extern void (__stdcall *grAlphaCombine)(GrCombineFunction_t function, GrCombineFactor_t factor, GrCombineLocal_t local, GrCombineOther_t other, FxBool invert);
extern void (__stdcall *grAlphaControlsITRGBLighting)(FxBool enable);
extern void (__stdcall *grAlphaTestFunction)(GrCmpFnc_t function);
extern void (__stdcall *grAlphaTestReferenceValue)(GrAlpha_t value);
extern void (__stdcall *grChromakeyMode)(GrChromakeyMode_t mode);
extern void (__stdcall *grChromakeyValue)(GrColor_t value);
extern void (__stdcall *grClipWindow)(FxU32 minx, FxU32 miny, FxU32 maxx, FxU32 maxy);
extern void (__stdcall *grColorCombine)(
               GrCombineFunction_t function, GrCombineFactor_t factor,
               GrCombineLocal_t local, GrCombineOther_t other,
               FxBool invert);
extern void (__stdcall *grColorMask)(FxBool rgb, FxBool a);
extern void (__stdcall *grCullMode)(GrCullMode_t mode);
extern void (__stdcall *grConstantColorValue)(GrColor_t value);
extern void (__stdcall *grConstantColorValue4)(float a, float r, float g, float b);
extern void (__stdcall *grDepthBiasLevel)(FxI16 level);
extern void (__stdcall *grDepthBufferFunction)(GrCmpFnc_t function);
extern void (__stdcall *grDepthBufferMode)(GrDepthBufferMode_t mode);
extern void (__stdcall *grDepthMask)(FxBool mask);
extern void (__stdcall *grDisableAllEffects)(void);
extern void (__stdcall *grDitherMode)( GrDitherMode_t mode);
extern void (__stdcall *grFogColorValue)( GrColor_t fogcolor);
extern void (__stdcall *grFogMode)(GrFogMode_t mode);
extern void (__stdcall *grFogTable)(const GrFog_t ft[GR_FOG_TABLE_SIZE]);
extern void (__stdcall *grGammaCorrectionValue)(float value);
extern void (__stdcall *grSplash)(float x, float y, float width, float height, FxU32 frame);
extern FxU32 (__stdcall *grTexCalcMemRequired)(
                     GrLOD_t lodmin, GrLOD_t lodmax,
                     GrAspectRatio_t aspect, GrTextureFormat_t fmt);
extern FxU32 (__stdcall *grTexTextureMemRequired)(FxU32 evenOdd, GrTexInfo *info);
extern FxU32 (__stdcall *grTexMinAddress)(GrChipID_t tmu);
extern FxU32 (__stdcall *grTexMaxAddress)(GrChipID_t tmu);
extern void (__stdcall *grTexNCCTable)(GrChipID_t tmu, GrNCCTable_t table);
extern void (__stdcall *grTexSource)(GrChipID_t tmu, FxU32 startAddress, FxU32 evenOdd, GrTexInfo  *info);
extern void (__stdcall *grTexClampMode)(GrChipID_t tmu, GrTextureClampMode_t s_clampmode, GrTextureClampMode_t t_clampmode);
extern void (__stdcall *grTexCombine)(
             GrChipID_t tmu,
             GrCombineFunction_t rgb_function,
             GrCombineFactor_t rgb_factor, 
             GrCombineFunction_t alpha_function,
...
extern void (__stdcall *grTexCombineFunction)(
                     GrChipID_t tmu,
                     GrTextureCombineFnc_t fnc
                     );
extern void (__stdcall *grTexDetailControl)(
                   GrChipID_t tmu,
                   int lod_bias,
                   FxU8 detail_scale,
                   float detail_max
                   );
extern void (__stdcall *grTexFilterMode)(
                GrChipID_t tmu,
                GrTextureFilterMode_t minfilter_mode,
                GrTextureFilterMode_t magfilter_mode
                );
extern void (__stdcall *grTexLodBiasValue)(GrChipID_t tmu, float bias);
extern void (__stdcall *grTexDownloadMipMap)(GrChipID_t tmu,
                     FxU32      startAddress,
                     FxU32      evenOdd,
                     GrTexInfo  *info);

extern void (__stdcall *grTexDownloadMipMapLevel)(GrChipID_t        tmu,
                          FxU32             startAddress,
                          GrLOD_t           thisLod,
                          GrLOD_t           largeLod,
                          GrAspectRatio_t   aspectRatio,
...
extern void (__stdcall *grTexDownloadMipMapLevelPartial)(GrChipID_t        tmu,
                                 FxU32             startAddress,
                                 GrLOD_t           thisLod,
                                 GrLOD_t           largeLod,
                                 GrAspectRatio_t   aspectRatio,
...
extern void (__stdcall *ConvertAndDownloadRle)(GrChipID_t        tmu,
                        FxU32             startAddress,
                        GrLOD_t           thisLod,
                        GrLOD_t           largeLod,
                        GrAspectRatio_t   aspectRatio,
...
extern void (__stdcall *grCheckForRoom)(FxI32 n);

extern void (__stdcall *grTexDownloadTable)(GrChipID_t   tmu,
                    GrTexTable_t type, 
                    void         *data);

extern void (__stdcall *grTexDownloadTablePartial)(GrChipID_t   tmu,
                           GrTexTable_t type, 
                           void         *data,
                           int          start,
                           int          end);

extern void (__stdcall *grTexMipMapMode)(GrChipID_t     tmu, 
                 GrMipMapMode_t mode,
                 FxBool         lodBlend);

extern void (__stdcall *grTexMultibase)(GrChipID_t tmu,
                FxBool     enable);

extern void (__stdcall *grTexMultibaseAddress)(GrChipID_t       tmu,
                       GrTexBaseRange_t range,
                       FxU32            startAddress,
                       FxU32            evenOdd,
                       GrTexInfo        *info);

extern GrMipMapId_t (__stdcall *guTexAllocateMemory)(
                    GrChipID_t tmu,
                    FxU8 odd_even_mask,
                    int width, int height,
                    GrTextureFormat_t fmt,
...
extern FxBool (__stdcall *guTexChangeAttributes)(
                      GrMipMapId_t mmid,
                      int width, int height,
                      GrTextureFormat_t fmt,
                      GrMipMapMode_t mm_mode,
...
extern void (__stdcall *guTexCombineFunction)(
                     GrChipID_t tmu,
                     GrTextureCombineFnc_t fnc
                     );
extern GrMipMapId_t (__stdcall *guTexGetCurrentMipMap)(GrChipID_t tmu);
extern GrMipMapInfo* (__stdcall *guTexGetMipMapInfo)(GrMipMapId_t mmid);
extern FxU32 (__stdcall *guTexMemQueryAvail)(GrChipID_t tmu);
extern void (__stdcall *guTexMemReset)(void);
extern void (__stdcall *guTexDownloadMipMap)(
                    GrMipMapId_t mmid,
                    const void *src,
                    const GuNccTable *table
                    );
extern void (__stdcall *guTexDownloadMipMapLevel)(
                         GrMipMapId_t mmid,
                         GrLOD_t lod,
                         const void **src
                         );
extern void (__stdcall *guTexSource)(GrMipMapId_t id);
extern void (__stdcall *guColorCombineFunction)(GrColorCombineFnc_t fnc);

extern FxBool (__stdcall *grLfbLock)( GrLock_t type, GrBuffer_t buffer, GrLfbWriteMode_t writeMode,
           GrOriginLocation_t origin, FxBool pixelPipeline, 
           GrLfbInfo_t *info);
extern FxBool (__stdcall *grLfbUnlock)(GrLock_t type, GrBuffer_t buffer);
extern void (__stdcall *grLfbConstantAlpha)(GrAlpha_t alpha);
extern void (__stdcall *grLfbConstantDepth)(FxU16 depth);
extern void (__stdcall *grLfbWriteColorSwizzle)(FxBool swizzleBytes, FxBool swapWords);
extern void (__stdcall *grLfbWriteColorFormat)(GrColorFormat_t colorFormat);
extern FxBool (__stdcall *grLfbWriteRegion)(GrBuffer_t dst_buffer, 
                  FxU32 dst_x, FxU32 dst_y, 
                  GrLfbSrcFmt_t src_format, 
                  FxU32 src_width, FxU32 src_height, 
                  FxI32 src_stride, void *src_data);

extern FxBool (__stdcall *grLfbReadRegion)(GrBuffer_t src_buffer,
                 FxU32 src_x, FxU32 src_y,
                 FxU32 src_width, FxU32 src_height,
                 FxU32 dst_stride, void *dst_data);

extern void (__stdcall *grAADrawLine)(const GrVertex *v1, const GrVertex *v2);
extern void (__stdcall *grAADrawPoint)(const GrVertex *pt);
extern void (__stdcall *grAADrawPolygon)(const int nverts, const int ilist[], const GrVertex vlist[]);
extern void (__stdcall *grAADrawPolygonVertexList)(const int nverts, const GrVertex vlist[]);
extern void (__stdcall *grAADrawTriangle)(
                 const GrVertex *a, const GrVertex *b, const GrVertex *c,
                 FxBool ab_antialias, FxBool bc_antialias, FxBool ca_antialias
                 );
extern void (__stdcall *grGlideInit)(void);
extern void (__stdcall *grGlideShutdown)(void);
extern void (__stdcall *grGlideGetVersion)(char version[80]);
extern void (__stdcall *grGlideGetState)(GrState *state);
extern void (__stdcall *grGlideSetState)( const GrState *state);
extern void (__stdcall *grGlideShamelessPlug)(const FxBool on);
extern void (__stdcall *grHints)(GrHint_t hintType, FxU32 hintMask);

extern float (__stdcall *guFogTableIndexToW)(int i);
extern void (__stdcall *guFogGenerateExp)( GrFog_t fogtable[GR_FOG_TABLE_SIZE], float density );
extern void (__stdcall *guFogGenerateExp2)( GrFog_t fogtable[GR_FOG_TABLE_SIZE], float density );
extern void (__stdcall *guFogGenerateLinear)( GrFog_t fogtable[GR_FOG_TABLE_SIZE], float nearZ, float farZ );

#endif	//_VOLITION_GLIDE_EXT