...
const float MAX_BURST_DAMAGE	= 20;		// max damage that can be done in BURST_DURATION
const float BURST_DURATION		= 500;	// decay time over which Player->damage_this_burst falls from MAX_BURST_DAMAGE to 0
