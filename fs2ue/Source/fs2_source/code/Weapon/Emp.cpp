...
// emp hud string
void emp_hud_string(int x, int y, int gauge_id, char *str, eHudAlign leAlign)
{
	char tmp[256] = "";
	...
	HUD_STRING(x, y, tmp, leAlign);
}

// emp hud printf
void emp_hud_printf(int x, int y, int gauge_id, eHudAlign leAlign, char *format, ...)
{
	char tmp[256] = "";
	va_list args;	
