...
void multi_ts_handle_mouse()
{
	...
	g_MouseController.GetPos(&mouse_x,&mouse_y);
	...
	if(!Multi_ts_carried_flag && Multi_ts_clicked_flag && !g_MouseController.IsDown(MouseController::MOUSE_LEFT_BUTTON)){
		Multi_ts_clicked_flag = 0;
	}

	// if we're currently not carrying anything and the user has clicked
	if(!Multi_ts_carried_flag && !Multi_ts_clicked_flag && g_MouseController.IsDown(MouseController::MOUSE_LEFT_BUTTON) && !region_empty){
	...
	if(!Multi_ts_carried_flag && Multi_ts_clicked_flag && g_MouseController.IsDown(MouseController::MOUSE_LEFT_BUTTON) && ((Multi_ts_clicked_x != mouse_x) || (Multi_ts_clicked_y != mouse_y))){
	...
	if(Multi_ts_carried_flag && !g_MouseController.IsDown(MouseController::MOUSE_LEFT_BUTTON)){
		Multi_ts_carried_flag = 0;
		Multi_ts_clicked_flag = 0;		
